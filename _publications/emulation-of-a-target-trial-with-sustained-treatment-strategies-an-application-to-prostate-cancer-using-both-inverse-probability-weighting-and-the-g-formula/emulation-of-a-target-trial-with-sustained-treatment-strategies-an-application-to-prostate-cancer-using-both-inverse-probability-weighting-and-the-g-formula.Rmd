...
citation_url: "https://doi.org/10.1007/s10654-022-00929-7"
...
distilltools::icon_link(
  icon = "doi",
  text = "Online version",
  url = "https://doi.org/10.1007/s10654-022-00929-7"
)
# 
distilltools::icon_link(
  icon = "fas fa-file-pdf",
  text = "PDF",
  url = "emulation-of-a-target-trial-with-sustained-treatment-strategies-an-application-to-prostate-cancer-using-both-inverse-probability-weighting-and-the-g-formula.pdf"
)
# 
# distilltools::icon_link(
#   icon = "arxiv",
