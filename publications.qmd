...
```{r}
library(tidyverse)
reviewed <- rmarkdown::pandoc_citeproc_convert("~/GitHub/CV/Reviewed.bib", type = "list")
# reports <- rmarkdown::pandoc_citeproc_convert("~/GitHub/CV/reports.bib", type = "list")
non_reviewed <- rmarkdown::pandoc_citeproc_convert("~/GitHub/CV/Non-reviewed.bib", type = "list")
all_pubs <- c(reviewed, non_reviewed)
...
# safe_pluck <- function(x, y) ifelse(is.null(pluck(x, y)), NA, pluck(x, y))
...
```{r}
all_pubs <- rmarkdown::pandoc_citeproc_convert("~/Documents/xxxCV/preprints.bib", type = "list")
ids <- map_chr(all_pubs, pluck, "id")
